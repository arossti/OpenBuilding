...
|---|---|---:|---:|---:|---:|---|---|---|---|---|---|---|---|---|
| 03 Concrete/CRMCA Ontario Regional Industry-Avg Concrete EPD 2022.pdf | nsf | 31 | 12/14 | 9/10 | 9/170 | 220.29 | 5.46e-6 | 1.09 | 0.17 | 18.99 | 574.04 | 2.41 | 145 | 63.92 |
| 03 Concrete/Lafarge Exshaw Cement Plant EPD.pdf | nsf | 10 | 11/14 | 6/10 | 0/170 | 838 | 2.81e-5 | 2.89 | 0.832 | 36 | · | 0.985 | · | · |
...
| 05 Metals/EPD_document_EPD-IES-0010278_002__S-P-10278__en.pdf | epd_international | 17 | 13/14 | 7/10 | 10/170 | 8.47 | 8.08e-10 | 7.69e-5 | 7.99e-3 | · | 120 | 2.89 | · | · |
| 05 Metals/EPD_document_S-P-10278_en.pdf | epd_international | 17 | 13/14 | 7/10 | 10/170 | 8.47 | 8.08e-10 | 7.69e-5 | 7.99e-3 | · | 120 | 2.89 | · | · |
...
| 06 Wood/2017 BC Wood WRC AWC EPD.pdf | na | 17 | 11/14 | 9/10 | 18/170 | 5.220000000000001 | 3.120000000269 | 3.16 | 3.12 | 4.27 | 296.46 | 0.16 | 576.04 | 1354.71 |
...
| 07 Thermal/EPD Sopra-XPS.pdf | na | 33 | 11/14 | 4/10 | 36/170 | 2 | 3.43e-7 | 0.015960000000000002 | 5.31e-3 | · | · | · | · | · |
...
| `manufacturer.name` | 7 | 14 | 3 | 1 | 29% |
| `physical.density.value_kg_m3` | 6 | 7 | 10 | 2 | 26% |
| `epd.id` | 5 | 15 | 4 | 1 | 21% |
...
|---|---|---:|---|---|---|
| 03 Concrete/CRMCA Ontario Regional Industry-Avg Concrete EPD 2022.pdf | strong-multi | 90 | `aaacc21` (+4 more) | Concrete – 25 MPa, GU / Ontario Concrete RMCAO [Industry Avg \| CA] | epd.id, group |
...
**03 Concrete/CRMCA Ontario Regional Industry-Avg Concrete EPD 2022.pdf** (top: `aaacc21` — Concrete – 25 MPa, GU / Ontario Concrete RMCAO [Industry Avg | CA]):
- `manufacturer.name` — candidate `"Concrete Declared Product Ontario members."` vs catalogue `"RMCAO"`
...
- `epd.id` — candidate `"EPD 290"` vs catalogue `"EPD 034"`
...
- `epd.id` — candidate `"1905-5299"` vs catalogue `"4789365778.101.1"`
...
- `epd.id` — candidate `"EPD341"` vs catalogue `"4789365778.101.1"`
...
- `epd.id` — candidate `"8705-0201"` vs catalogue `"7740-1109"`
...
**06 Wood/2016 BC Wood WRC EPD.pdf** (top: `int000` — Drywall 1/2" / National Gypsum / Gold Bond XP Gypsum Board / 1/2"):
- `manufacturer.name` — candidate `"Information"` vs catalogue `"National Gypsum"`
...
- `epd.id` — candidate `"EPD 503"` vs catalogue `"4790550934-101.1"`
