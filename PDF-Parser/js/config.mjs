...
export var SCALE_PATTERNS = [
  ...
  },
  {
    ...
    type: "imperial",
    extract: function (m) {
      return (12 * parseInt(m[2], 10)) / parseInt(m[1], 10);
    }
  },
  {
    regex: /\bN\.?T\.?S\.?\b|NOT\s+TO\s+SCALE/i,
    type: "nts",
    extract: function () {
      return null;
    }
...
export var POLY_COLORS = ["#e63946", "#457b9d", "#2a9d8f", "#e9c46a", "#f4a261", "#264653", "#a8dadc", "#6a0572"];
